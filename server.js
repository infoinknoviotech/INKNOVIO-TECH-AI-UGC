...
const seoHead = [
  ...
  '<link rel="icon" href="/assets/inknovio-favicon.svg?v=icons" type="image/svg+xml">',
  '<link rel="icon" href="/assets/inknovio-favicon-16.png?v=icons" type="image/png" sizes="16x16">',
  '<link rel="icon" href="/assets/inknovio-favicon-32.png?v=icons" type="image/png" sizes="32x32">',
  '<link rel="icon" href="/assets/inknovio-favicon-48.png?v=icons" type="image/png" sizes="48x48">',
  '<link rel="apple-touch-icon" href="/assets/inknovio-favicon-180.png?v=icons" sizes="180x180">',
